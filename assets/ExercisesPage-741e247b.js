import{P as c,j as e,u as b,J as R,K as q,M as L,r as h,b as g,O as Q,S as _,I as m,T as $,U as f,V as ee,W as w,L as te}from"./index-e797a4b6.js";import{s as t}from"./styled-components.browser.esm-812dc110.js";import{r as D}from"./react-responsive-1b5d2d62.js";import{d as ie,a as ne}from"./default-desktop-2x-2695cc1e.js";const oe=i=>i.exercises.title,re=i=>i.exercises.category,se=i=>i.exercises.isToggled,ae=i=>i.exercises.exerciseIndex,ce=i=>i.exercises.isSuccess,le=i=>i.exercises.modalIsOpen,de=i=>i.exercises,xe=i=>i.exercises.allExercises,pe=t.h1`
  margin-bottom: 20px;
  color: #efede8;
  font-family: Roboto;
  font-size: 24px;
...
`,B=({title:i})=>e.jsx(pe,{children:i||"Exercises"});B.propTypes={title:c.string};const he=t.li`
...
`,F=({imgURL:i,name:o,filter:s})=>{const n=b(),r=(a,l)=>{n(R(l)),n(q()),a==="Body parts"?n(L({bodyPartTitle:l.toString().toLowerCase(),equipmentTitle:"",targetTitle:""})):a==="Muscles"?n(L({bodyPartTitle:"",equipmentTitle:"",targetTitle:l.toString().toLowerCase()})):a==="Equipment"&&n(L({bodyPartTitle:"",equipmentTitle:l.toString().toLowerCase(),targetTitle:""}))};return e.jsx(he,{onClick:()=>r(s,o),children:e.jsxs(ge,{children:[e.jsx(me,{src:i,alt:o}),e.jsxs(be,{children:[e.jsx(ue,{children:o}),e.jsx(fe,{children:s})]})]})})};F.propTypes={imgURL:c.string,name:c.string,filter:c.string};const Y=t.div`
  display: flex;
...
`,je="_radiobutton_mtojw_1",we={radiobutton:je};function P({itemsPerPage:i,category:o}){const s=D.useMediaQuery({minWidth:768,maxWidth:1439.8}),[n,r]=h.useState(1),a=b(),d=g(de)[o||"bodyparts"],x=Math.ceil(d.length/i),y=u=>{r(u)},j=(n-1)*i,E=j+i,C=d.slice(j,E);return h.useEffect(()=>{r(1),a(Q())},[a,o]),e.jsxs(Y,{children:[e.jsx(ye,{children:C.map(({filter:u,name:p,imgURL:T,_id:W})=>e.jsx(F,{id:W,imgURL:T,name:p.charAt(0).toUpperCase()+p.slice(1),filter:u.charAt(0).toUpperCase()+u.slice(1)},W))}),d.length>10||s?e.jsx("div",{style:{display:"inline-flex",justifyContent:"center",marginRight:8,gap:8},children:Array.from({length:x},(u,p)=>e.jsxs("label",{className:we.radiobutton,children:[e.jsx("input",{type:"radio",name:"active-page",checked:n===p+1,onChange:()=>y(p+1)}),e.jsx("span",{})]},p))}):null]})}const M=({page:i})=>{const o=D.useMediaQuery({minWidth:768,maxWidth:1439.8});return e.jsx(Y,{children:e.jsx("div",{children:e.jsx(P,{category:i,itemsPerPage:o?9:10})})})};M.propTypes={page:c.string};P.propTypes={itemsPerPage:c.number,category:c.string};const ve="_container_rxzv8_1",ke="_category_rxzv8_8",ze="_activecategory_rxzv8_23 _category_rxzv8_8",Se="_categorygroup_rxzv8_41",Ce="_categoryitem_rxzv8_48",v={container:ve,category:ke,activecategory:ze,categorygroup:Se,categoryitem:Ce},Ee=[{title:"Body parts",route:"bodyparts"},{title:"Muscules",route:"muscules"},{title:"Equipments",route:"equipments"}],H=({titleName:i})=>{const[o,s]=h.useState(0),n=b();return e.jsx("div",{className:v.container,children:e.jsx("ul",{className:v.categorygroup,children:Ee.map(({title:r,route:a},l)=>e.jsx("li",{className:v.categoryitem,children:e.jsx("button",{className:`${l===o&&i==="Exercises"?v.activecategory:v.category}`,onClick:()=>{n(_(a)),s(l)},disabled:i!=="Exercises",children:r})},l))})})};H.propTypes={titleName:c.string};const Te=t.li`
  border: 1px solid rgba(239, 237, 232, 0.2);
  border-radius: 12px;
...
`,Ke=t.span`
  ...
  align-items: center;
`,O=({name:i,burnedCalories:o,bodyPart:s,target:n,id:r})=>{const a=b();return e.jsxs(Te,{children:[e.jsx(Le,{children:"WORKOUT"}),e.jsxs(Ue,{children:[e.jsx(Ke,{children:e.jsx("svg",{width:"24",height:"24",style:{fill:"#EFEDE8",zIndex:10},children:e.jsx("use",{href:m+"#icon-running"})})}),e.jsx(Ae,{children:i})]}),e.jsxs(We,{children:[e.jsxs(U,{children:["Burned calories: ",e.jsx(A,{children:o})]}),e.jsxs(U,{children:["Body part: ",e.jsx(A,{children:s})]}),e.jsxs(U,{children:["Target: ",e.jsx(A,{children:n})]})]}),e.jsxs(Xe,{type:"button",onClick:()=>{a($(r)),a(f())},children:["Start",e.jsx("svg",{width:16,height:16,style:{verticalAlign:"top",stroke:"#E6533C"},children:e.jsx("use",{href:m+"#icon-next"})})]})]})};O.propTypes={name:c.string,burnedCalories:c.number,bodyPart:c.string,target:c.string,index:c.number,id:c.string};const Ve=t.div`
  display: flex;
  @media screen and (min-width: 1440px) {
    max-height: 726px;
  }
...
`,qe="_overlay_y08h9_1",De="_overlayhidden_y08h9_20",X={overlay:qe,overlayhidden:De},Be=t.div`
  width: 335px;
  z-index: 5;
  display: flex;
  position: relative;
...
`,ct=t.span`
  ...
  right: 16px;
  cursor: pointer;
`,J=({data:i,setCurrentTime:o})=>{const{time:s,burnedCalories:n}=i,r=b();return e.jsxs(nt,{children:[e.jsx(ct,{onClick:()=>{r(f()),r(w()),o(180)},children:e.jsx("svg",{stroke:"#EFEDE8",width:26,height:26,children:e.jsx("use",{href:m+"#icon-close"})})}),e.jsx(ot,{children:e.jsx("img",{src:it,alt:"like"})}),e.jsx(rt,{children:"Well done"}),e.jsxs("ul",{children:[e.jsxs(K,{children:[e.jsx(V,{children:"Your time:"}),e.jsxs(I,{children:[s,"minutes"]})]}),e.jsxs(K,{children:[e.jsx(V,{children:"Burned calories:"}),e.jsx(I,{children:n})]})]}),e.jsx(st,{type:"submit",onClick:()=>{r(w()),r(f())},children:"Next exercise"}),e.jsxs(at,{onClick:()=>{r(f()),r(w())},to:"/diary",children:["To the diary",e.jsx("svg",{width:16,height:16,style:{stroke:"rgba(239, 237, 232, 0.30)",verticalAlign:"top"},children:e.jsx("use",{href:m+"#icon-next"})})]})]})};J.propTypes={data:c.object,setCurrentTime:c.func};const G=({data:i})=>{const[o,s]=h.useState(180),n=g(ce),r=g(le),a=b();h.useEffect(()=>{const d=x=>{x.code==="Escape"&&(a(f()),s(180),n&&a(w()))};return document.addEventListener("keydown",d),()=>{document.removeEventListener("keydown",d)}},[a]);const l=d=>{d.target===d.currentTarget&&(a(f()),s(180),n&&a(w()))};return e.jsx("div",{className:`${r&&i?X.overlayhidden:X.overlay}`,onClick:l,children:n?e.jsx(J,{data:i,currentTime:o,setCurrentTime:s}):e.jsx(N,{data:i,currentTime:o,setCurrentTime:s})})};G.propTypes={data:c.object};const lt=()=>{const i=g(ae),o=g(xe),s=o.find(({_id:n})=>n===i);return e.jsxs(Ve,{children:[e.jsx(Ie,{children:o.map(({bodyPart:n,name:r,target:a,burnedCalories:l,_id:d},x)=>e.jsx(O,{name:r.charAt(0).toUpperCase()+r.slice(1),burnedCalories:l,bodyPart:n.charAt(0).toUpperCase()+n.slice(1),target:a.charAt(0).toUpperCase()+a.slice(1),id:d},x))}),e.jsx(Re,{}),s&&e.jsx(G,{data:s})]})},dt=t.div`
  width: 335px;
  margin-left: auto;
  margin-right: auto;
  padding-top: 40px;
...
`,ut=()=>{const i=g(se),o=g(re),s=g(oe),n=b();return e.jsxs(dt,{children:[i&&e.jsxs(xt,{onClick:()=>{n(q()),n(R("Exercises"))},children:[e.jsx("svg",{width:16,height:16,style:{stroke:"rgba(239, 237, 232, 0.4)"},children:e.jsx("use",{href:m+"#icon-back"})}),"Back"]}),e.jsxs(pt,{children:[e.jsx(B,{title:s}),e.jsx(H,{titleName:s||"Exercises"})]}),i?e.jsx(lt,{}):e.jsx(M,{page:o})]})};export{ut as default};
